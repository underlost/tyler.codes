...
const AboutPage = () => (
  <Layout>
    ...
    <p className={`mt-4`}>
      Sites like Instagram only provide a single link in your bio. I built this site as a way to easily link to blog posts, ands anything recent or interesting I might want to share on
      Instargram and other sites, with out the need to always update the profile link.
    </p>
    <p>
